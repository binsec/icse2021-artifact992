...
inline int ext2fs_set_bit(unsigned int nr, void * addr)
{
 int oldbit;
...
inline int ext2fs_clear_bit(unsigned int nr, void * addr)
{
 int oldbit;
...
inline int ext2fs_test_bit(unsigned int nr, const void * addr)
{
 int oldbit;
